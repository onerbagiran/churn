...
scaler = pickle.load(open('scaler.pkl', 'rb')) # Scaler'ı yeniden oluşturacağız, çünkü model eğitimi sırasında kullanılan scaler kaydedilmemiş
...
if submitted:
    ...
    # Veriyi ölçeklendir
    input_scaled = scaler.fit_transform(input_df)  # Not: Gerçek uygulamada scaler model eğitimi sırasında kaydedilmeli ve yeniden kullanılmalı
